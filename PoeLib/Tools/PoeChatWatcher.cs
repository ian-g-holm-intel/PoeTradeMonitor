...
/// <summary>
/// Interface for watching Path of Exile chat log files for game events.
/// </summary>
...
/// <summary>
/// Watches Path of Exile chat log files for game events and messages.
/// </summary>
public class PoeChatWatcher : IPoeChatWatcher
{
    ...
    /// <summary>
    /// Starts watching the Path of Exile log file for chat messages and game events.
    /// </summary>
                        ...
                        try
                        {
                            ...
                            if ((line = sr.ReadLine()) != null)
                            {
                                ...
                                if (messageParser.TryParseIncomingCharacterMessage(line, out var incomingCharacterMessage))
                                {
                                    ...
                                    if (incomingCharacterMessage != null)
                                    {
                                ...
                                {
                                    if (outgoingCharacterMessage != null)
