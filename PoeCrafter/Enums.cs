...
/// <summary>
/// Represents the tier level of an affix, where Tier1 is the highest and most powerful.
/// </summary>
...
/// <summary>
/// Represents the type of affix on an item.
/// </summary>
...
/// <summary>
/// Represents specific modifier types that can appear on Path of Exile items.
/// Each enum value includes description and pattern attributes for parsing.
/// </summary>
public enum ModType
{
