...
public class MapStashTabElementWrapper : ElementWrapper
{
    ...
    public Dictionary<string, ElementWrapper> CurrentCellElements => GetCurrentCellElements();
    public Dictionary<string, ElementWrapper> TierElements => GetTierElements();
    ...
    private Dictionary<string, ElementWrapper> GetCurrentCellElements()
    {
        var cell = Children[2].Children[0].Children[0].Children;
        var result = new Dictionary<string, ElementWrapper>();
    ...
    private Dictionary<string, ElementWrapper> GetTierElements()
    {
        var Rows = Children[0].Children.Concat(Children[1].Children);
        var result = new Dictionary<string, ElementWrapper>();
        var i = 1;
